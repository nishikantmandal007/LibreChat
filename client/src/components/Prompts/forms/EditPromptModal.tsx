      ...
      <Dialog as="div" className="relative z-50" onClose={() => onOpenChange(false)}>
        ...
        >
          <div className="fixed inset-0 flex w-screen items-center justify-center p-4">
            <DialogPanel className="aisafe-glass-dialog flex h-[680px] max-h-[calc(100dvh-2rem)] w-full max-w-[876px] flex-col overflow-hidden rounded-xl shadow-2xl backdrop-blur-2xl animate-in">
              <DialogTitle
