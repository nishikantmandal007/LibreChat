          ...
          <TooltipAnchor
            ...
            render={
              <Ariakit.MenuButton
                ...
                className={cn(
                  'mt-text-sm glass-surface-subtle flex size-10 flex-shrink-0 items-center justify-center gap-2 rounded-xl text-sm transition-colors duration-200 hover:bg-white/40',
