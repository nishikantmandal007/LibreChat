        ...
        <div className={'relative w-full'}>
          <Trigger asChild>
            <button
              ...
              className={cn(
                'glass-surface pointer-cursor relative flex flex-col rounded-xl py-2 pl-3 pr-10 text-left text-[var(--glass-text)] focus:ring-0 focus:ring-offset-0 sm:text-sm',
          ...
          <Portal>
            <Content
              ...
              align="start"
              className={cn(
                'aisafe-glass-dialog backdrop-blur-2xl z-50 mr-3 mt-2 max-h-[52vh] w-full max-w-[85vw] overflow-hidden overflow-y-auto rounded-xl text-[var(--glass-text)] shadow-lg sm:max-w-full lg:max-h-[52vh]',
